...
},{"../package.json":114,"./integrations":2,"@segment/analytics.js-core":22}],2:[function(require,module,exports){
...
},{"@segment/analytics.js-integration-segmentio":33}],3:[function(require,module,exports){
'use strict';
...
},{"./cookie":19,"./group":21,"./memory":23,"./normalize":24,"./pageDefaults":25,"./store":26,"./user":27,"@ndhoule/after":3,"@ndhoule/clone":5,"@ndhoule/defaults":6,"@ndhoule/each":8,"@ndhoule/foldl":11,"@ndhoule/keys":13,"@ndhoule/pick":15,"@segment/is-meta":42,"@segment/prevent-default":56,"bind-all":62,"component-emitter":28,"component-event":69,"component-querystring":71,"component-type":73,"debug":29,"is":81,"next-tick":89,"segmentio-facade":98}],19:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/clone":5,"@ndhoule/defaults":6,"@segment/top-domain":60,"bind-all":62,"component-cookie":65,"debug":29,"json3":82}],20:[function(require,module,exports){
'use strict';
...
},{"./cookie":19,"./memory":23,"./store":26,"@ndhoule/clone":5,"@ndhoule/defaults":6,"@ndhoule/extend":10,"@segment/isodate-traverse":43,"debug":29}],21:[function(require,module,exports){
'use strict';
...
},{"./entity":20,"bind-all":62,"debug":29,"inherits":79}],22:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/clone":5,"bind-all":62}],24:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/defaults":6,"@ndhoule/each":8,"@ndhoule/includes":12,"@ndhoule/map":14,"component-type":73,"debug":29}],25:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/includes":12,"@segment/canonical":40,"component-url":74}],26:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/defaults":6,"@segment/store":59,"bind-all":62}],27:[function(require,module,exports){
'use strict';
...
},{"./cookie":19,"./entity":20,"bind-all":62,"component-cookie":65,"debug":29,"inherits":79,"uuid":31}],28:[function(require,module,exports){
...
},{"./rng":30}],32:[function(require,module,exports){
module.exports={
  "_args": [
    [
      "@segment/analytics.js-core@3.0.0",
      "/Users/matteogatti/Web/analytics-okgrow"
    ]
  ],
  ...
  "_spec": "3.0.0",
  "_where": "/Users/matteogatti/Web/analytics-okgrow",
  "author": {
    "name": "Segment",
...
Segment.prototype.base64EncodeUnicode = function(str) {
...
Segment.prototype.enqueue = function(path, msg, fn) {
  ...
  var headers = {
      ...
      'Authorization': this.base64EncodeUnicode(this.options.apiKey)
  };

  // extends context with external data
  if (msg['context'] && typeof msg['context'] === 'object') {
      msg['context'] = this.extend(msg['context'], this.options.context)
  }

  // add frontend version
  msg['frontendVersion'] = this.options.version;
...
},{"@ndhoule/extend":10,"@ndhoule/keys":13,"@segment/ad-params":17,"@segment/analytics.js-integration":34,"@segment/localstorage-retry":47,"@segment/protocol":57,"@segment/send-json":58,"@segment/top-domain":60,"@segment/utm-params":61,"component-clone":64,"component-cookie":65,"json3":82,"spark-md5":105,"uuid":111,"yields-store":112}],34:[function(require,module,exports){
'use strict';
...
},{"./protos":35,"./statics":36,"@ndhoule/clone":5,"@ndhoule/defaults":6,"@ndhoule/extend":10,"component-bind":63,"debug":75,"slug-component":104}],35:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/after":3,"@ndhoule/each":8,"@ndhoule/every":9,"@ndhoule/foldl":11,"@segment/fmt":41,"@segment/load-script":45,"analytics-events":37,"component-emitter":68,"is":81,"load-iframe":84,"next-tick":89,"to-no-case":38}],36:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/each":8,"@ndhoule/includes":12,"component-emitter":68,"domify":77}],37:[function(require,module,exports){
...
},{"utf8-encode":109}],40:[function(require,module,exports){
'use strict';
...
},{"@segment/isodate":44,"component-each":66,"component-type":73}],44:[function(require,module,exports){
'use strict';
...
},{"component-type":73,"next-tick":89,"script-onload":92}],46:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/keys":13,"uuid":51}],47:[function(require,module,exports){
'use strict';
...
},{"./schedule":48,"./store":49,"@ndhoule/each":8,"component-emitter":68,"debug":50,"uuid":51}],48:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/each":8}],49:[function(require,module,exports){
'use strict';
...
},{"./engine":46,"@ndhoule/each":8,"@ndhoule/keys":13,"json3":82}],50:[function(require,module,exports){
...
},{"./v1":54,"./v4":55}],52:[function(require,module,exports){
/**
...
},{"./lib/bytesToUuid":52,"./lib/rng":53}],55:[function(require,module,exports){
var rng = require('./lib/rng');
var bytesToUuid = require('./lib/bytesToUuid');
...
},{"./lib/bytesToUuid":52,"./lib/rng":53}],56:[function(require,module,exports){
'use strict';
...
},{"@segment/base64-encode":39,"has-cors":78,"json3":82,"jsonp":83}],59:[function(require,module,exports){
(function (global){
"use strict"
...
},{"json3":82}],60:[function(require,module,exports){
'use strict';
...
},{"component-cookie":65,"component-url":74}],61:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/foldl":11,"component-querystring":71}],62:[function(require,module,exports){
'use strict';
...
},{"component-bind":63}],63:[function(require,module,exports){
/**
 * Slice reference.
 */
...
},{"component-type":73,"type":73}],65:[function(require,module,exports){
...
},{"debug":75}],66:[function(require,module,exports){
...
},{"component-type":67,"to-function":106,"type":67}],67:[function(require,module,exports){
...
},{"trim":107,"type":72}],72:[function(require,module,exports){
/**
 * toString ref.
 */
...
},{"./debug":76,"_process":91}],76:[function(require,module,exports){
...
},{"ms":85}],77:[function(require,module,exports){
...
},{"debug":75}],84:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"./milliseconds":87,"./seconds":88,"@segment/isodate":44,"is":81}],87:[function(require,module,exports){
'use strict';
...
},{"./address":93,"./is-enabled":99,"./utils":103,"@segment/isodate-traverse":43,"new-date":86,"obj-case":90}],96:[function(require,module,exports){
'use strict';
...
},{"./facade":95,"./utils":103,"is-email":80,"new-date":86,"obj-case":90,"trim":107}],98:[function(require,module,exports){
'use strict';
...
},{"@ndhoule/clone":5,"inherits":79,"type-component":108}],104:[function(require,module,exports){
...
},{"component-props":70,"props":70}],107:[function(require,module,exports){
...
},{"./rng":110,"dup":31}],112:[function(require,module,exports){
...
},{"each":66,"unserialize":113}],113:[function(require,module,exports){
